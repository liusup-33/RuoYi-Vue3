  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="类别名称" prop="categoryId">
        <el-select v-model="queryParams.categoryId" placeholder="请选择类别名称" clearable>
          <el-option
            v-for="dict in book_category"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="区域名称" align="center" prop="regionId">
        <template #default="scope">
          <dict-tag :options="book_region" :value="scope.row.regionId"/>
        </template>
      </el-table-column>
      <el-table-column label="类别名称" align="center" prop="categoryId">
        <template #default="scope">
          <dict-tag :options="book_category" :value="scope.row.categoryId"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="bookRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="区域名称" prop="regionId">
          <el-select v-model="form.regionId" placeholder="请选择区域名称">
            <el-option
              v-for="dict in book_region"
              :key="dict.value"
              :label="dict.label"
        ...
        <el-form-item label="类别名称" prop="categoryId">
          <el-select v-model="form.categoryId" placeholder="请选择类别名称">
            <el-option
              v-for="dict in book_category"
              :key="dict.value"
              :label="dict.label"
...
const { book_region, book_category } = proxy.useDict('book_region', 'book_category');
